...
const Skills = () => {
  ...
  const skillSections = [
    ...
    },
    {
      ...
      icon: (
        <Server
          size={56}
          style={{ marginBottom: "1.5rem", color: "#8AB4F8" }}
        />
      ),
      tags: [
        "Node.js",
  ...
  return (
    <>
      ...
      <div
        id="skills"
        className="container-fluid min-vh-100 d-flex flex-column justify-content-center content-container"
        style={{ overflowX: "hidden", display: "flex", alignItems: "center" }}
      >
        <div
          className="w-100"
          style={{
        ...
        >
          <div className="text-center mb-5">
            <h1 className="about-me-title" style={{ marginBottom: "1rem" }}>
              SKILLS & EXPERTISE
            </h1>

            <p
              className="lead"
              style={{ fontSize: "clamp(0.9rem,2.5vw,1.3rem)", color: "#555" }}
            >
              A collection of my technical and professional abilities.
            </p>
          </div>

          <div className="container-fluid p-0" style={{ padding: 0 }}>
            <h4
                ...
                >
                  <GlowingCards className="w-100">
                    <GlowingCard
                      ...
                      className="polaroid-card skill-card w-100 h-100 no-hover-effect"
                      style={{
                        ...cardStyle,
                        width: "100%",
                        maxWidth: "420px",
            ...
            >
              ...
              >
                <BrainCircuit size={40} style={{ marginRight: "1rem" }} /> My
                Skills
              </h4>
                ...
                >
                  <GlowingCards className="w-100">
                    <GlowingCard
                      ...
                      className="skill-card h-100 p-4 w-100 no-hover-effect"
                      style={{
                        ...cardStyle,
                        width: "100%",
                        maxWidth: "420px",
